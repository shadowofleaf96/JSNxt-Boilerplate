...
const Testimonials: React.FC = () => {
  ...
  return (
    <div
      id="testimonials"
      className="relative z-10 mt-12 bg-muted/40 pb-2 sm:mt-16 sm:pb-4 xl:pb-0"
    >
      <div aria-hidden="true" className="absolute inset-0 overflow-hidden">
        <div className="absolute top-[calc(50%-36rem)] left-[calc(50%-19rem)] transform-gpu blur-3xl">
          <div
            ...
            className="aspect-1097/1023 w-[68.5625rem] bg-gradient-to-r from-primary/30 to-secondary/30 opacity-25"
          />
        </div>
      </div>
      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-x-8 gap-y-10 px-6 sm:gap-y-8 lg:px-8 xl:flex-row xl:items-stretch">
        ...
        <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
          <Card className="bg-transparent border-none shadow-none">
            <CardContent className="relative isolate pt-6 sm:pt-12 p-0">
              <figure>
                <Quote className="absolute top-0 left-0 text-primary/20 h-12 w-12" />
